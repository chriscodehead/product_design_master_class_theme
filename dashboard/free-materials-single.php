                ...
                <div class="toggle-expand-content expanded" data-content="quick-access">
                    <div class="nk-files nk-files-view-grid">
                        <div class="nk-files-list">
                            ...
                            <?php $sql = query_sql("SELECT * FROM $course_tb  WHERE `id`='".$id."' ");
                            if(mysqli_num_rows($sql)>0){ $c=0;
                                while($row = mysqli_fetch_assoc($sql)){?> 

                            <div class="nk-file-item nk-file">
                                <div class="nk-file-info">
                                    <a target="_blank" href="<?php print $row['download_link'];?>" class="nk-file-link">
                                        <div class="nk-file-title">
                                            ...
                                            <div class="nk-file-name">
                                                <div class="nk-file-name-text">
                                                    <span target="_blank" href="<?php print $row['download_link'];?>" class="title"><?php print $row['title'];?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="nk-file-actions hideable">
                                    <a target="_blank" href="<?php print $row['download_link'];?>" class="btn btn-sm btn-icon btn-trigger"><em class="icon ni ni-link"></em></a>
                                </div>
                            </div>

                            <p><?php print $row['description'];?> <br>
                            <small class="text-success">@<?php print $row['admin_name'];?> | <?php print $row['date_add'];?></small>
                            </p>

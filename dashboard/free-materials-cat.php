...
if (isset($_GET['id'])) {
   $id = $_GET['id'];
    ...
    header('location:free-materials');
}

$cat = $cal->selectFrmDB($cat_tb,'title','id',$id);
...
$total_pages_sql = "SELECT COUNT(*) FROM $course_tb WHERE `course_cat`='".$cat."' ";
...
<body class="nk-body bg-white has-sidebar ">
                ...
                <div class="toggle-expand-content expanded" data-content="quick-access">
                    <div class="nk-files nk-files-view-grid">
                        <div class="nk-files-list">
                            ...
                            <?php $sql = query_sql("SELECT * FROM $course_tb  WHERE `course_cat`='".$cat."' ORDER BY id ASC LIMIT $offset, $no_of_records_per_page");
                            if(mysqli_num_rows($sql)>0){ $c=0;
                                while($row = mysqli_fetch_assoc($sql)){?> 

                            <div class="nk-file-item nk-file">
                                <div class="nk-file-info">
                                    <a target="_blank" href="./dashboard/free-materials-single?id=<?php print $row['id'];?>" class="nk-file-link">
                                        <div class="nk-file-title">
                                            ...
                                            <div class="nk-file-name">
                                                <div class="nk-file-name-text">
                                                    <span target="_blank" href="./dashboard/free-materials-single?id=<?php print $row['id'];?>" class="title"><?php print $row['title'];?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="nk-file-actions hideable">
                                    <a target="_blank" href="./dashboard/free-materials-single?id=<?php print $row['id'];?>" class="btn btn-sm btn-icon btn-trigger"><em class="icon ni ni-link"></em></a>
                                </div>
                            </div>
    ...
    <div class="card-inner">
        <ul class="pagination justify-content-center justify-content-md-start">
            <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>"><a class="page-link" href="<?php if($page <= 1){ echo '#'; } else { echo "./dashboard/free-materials-cat?id=".$_GET['id']."&page=".($page - 1); } ?>">Prev</a></li>

            <li class="page-item"><a class="page-link" href="./dashboard/free-materials-cat?id=<?php print $_GET['id'];?>&page=1">1</a></li>
            <li class="page-item"><span class="page-link"><em class="icon ni ni-more-h"></em></span></li>

            <li class="page-item"><a class="page-link" href="./dashboard/free-materials-cat?id=<?php print $_GET['id'];?>&page=<?php echo $total_pages; ?>">Last</a></li>

            <li class="page-item <?php if($page >= $total_pages){ echo 'disabled'; } ?>"><a class="page-link" href="<?php if($page >= $total_pages){ echo '#'; } else { echo "./dashboard/free-materials-cat?id=".$_GET['id']."&page=".($page + 1); } ?>">Next</a></li>
        </ul>
    </div>

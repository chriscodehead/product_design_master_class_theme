        ...
        <div class="nk-main ">
            ...
            <div class="nk-wrap ">
                            ...
                            <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                <div class="nk-block-head-content text-center">
                                    ...
                                    <div class="nk-block-des">
                                        <p>Welcome to your <strong> <?php print $siteName;?></strong>. You are few steps away from completing your account registration. These are required to start earning on our platform! Let’s start!</p>
                                    </div>
                                </div>
                            </div><!-- .nk-block-head -->
                            <div class="nk-block">
                                                ...
                                                <div class="card-inner">
                                                    <ul class="list list-step">
                                                        ...
                                                        <?php if($sqli->getRow($sqli->getEmail($_SESSION['user_code']),'payment_activation_status')=='no'){ $b=0; $bb=0;?>
                                                            <li class="list-step-curren"><a href="./dashboard/deposit">Verify account</a></li>
                                                        ...
                                                        <?php if($sqli->getRow($sqli->getEmail($_SESSION['user_code']),'usdt')==''){ $c=0; $cc=0;?>
                                                            <li class="list-step-curren"><a href="./dashboard/add-wallet">Set up payment wallet</a></li>
                                                ...
                                                <div class="align-center flex-wrap flex-md-nowrap g-3 h-100">
                                                    ...
                                                    <div class="nk-block-content">
                                                        ...
                                                        <ul class="list list-sm list-checked">
                                                            ...
                                                            <li>Verify your account by making one time $<?php print $initial_pay;?> initial deposit</li>
                                                        </ul>
                                                        <a href="./dashboard/deposit" class="btn btn-lg btn-primary">Get Started</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="nk-block">
                    <div class="card card-custom-s1 card-bordered">
                        <div class="row no-gutters">
                            <div class="col-lg-12" style="padding-bottom: 20px; padding-top: 20px;"><center><a href="./dashboard/" class="btn btn-lg btn-primary">Get Started</a></center></div>
                        </div>
                    </div>
                </div>
                <?php require_once('info.php');?>

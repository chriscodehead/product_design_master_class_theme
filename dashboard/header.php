            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                            ...
                            <div class="dropdown-inner user-account-info">
                                ...
                                <a href="./dashboard/withdraw" class="link"><span>Withdraw Funds</span> <em class="icon ni ni-wallet-out"></em></a>
                            </div>
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    ...
                                    <!--<li><a href="./dashboard/profile-activity"><em class="icon ni ni-activity-alt"></em><span>Login Activity</span></a></li>-->
                    ...
                    <li class="dropdown notification-dropdown mr-n1">
                        <a href="./dashboard/notification" class="nk-quick-nav-icon">

                                        ...
                                        <div class="card-inner p-0">
                                            <div class="nk-tb-list nk-tb-tnx">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <?php print nl2br($cal->selectFrmDB($news,'news','id',$get_id));?>
                                                    
                                                    </p>
                                                    <?php $post_image = $cal->selectFrmDB($news,'post_image','id',$get_id);?>

                                                    <?php if(!empty($post_image)){?>
                                                    <p style="padding-left: 20px;"><img src="./img/6583130.png" width="20px"></img><a target="_blank" href="./photo/<?php print $post_image;?>">View Attachment</a></p>
                                                    <?php }?>

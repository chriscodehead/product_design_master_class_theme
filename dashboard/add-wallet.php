                                ...
                                <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                    <div class="nk-block-head-content text-center">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Please provide your USDT (<?php print $usdtnetwork;?>) wallet address in the field provided below. </p>
                                        </div>
                                    </div>
                                </div>
                                <?php if(!empty($msg)){?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <label class="form-label">Enter USDT wallet address(<?php print $usdtnetwork;?>) <span class="text-danger">*</span></label>
                                                            </div>

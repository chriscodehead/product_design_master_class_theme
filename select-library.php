			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				if ($row['coin_type'] == "BTC") {
					if ($row['btc_address'] == "none") {
						$addressy = 'Network Problem contact: support@creativehubacademy.centadesk.com';
					} else {
						$addressy = @$row['btc_address'];
					}
				} else if ($row['coin_type'] == "ETH") {
					if ($row['ethereum_address'] == "none") {
						$addressy = 'Network Proble contact: support@creativehubacademy.centadesk.com';
					} else {
...
you already made payment. Have any problem? Contact us @ support@creativehubacademy.centadesk.com</td>
								 </tr>'*/;
				} else {
					$add = '';
				}
		...
		if ($stmt) {
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				if ($row['email_activation'] == 'yes') {
					...
					$activation = '<a target="_blank" href ="https://creativehubacademy.centadesk.com/ActivateMail/activate.php?id=' . $row['email'] . '&ip=' . $row['password'] . '">Activate</a>';
				}

                                    ...
                                    <div class="card-inner-group">
                                        ...
                                        <div class="card-inner">
                                            <ul class="pagination justify-content-center justify-content-md-start">
                                                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>"><a class="page-link" href="<?php if($page <= 1){ echo '#'; } else { echo "./dashboard/my-referrals?page=".($page - 1); } ?>">Prev</a></li>
                                                <li class="page-item"><a class="page-link" href="./dashboard/my-referrals?page=1">1</a></li>
                                                <li class="page-item"><span class="page-link"><em class="icon ni ni-more-h"></em></span></li>
                                                <li class="page-item"><a class="page-link" href="./dashboard/my-referrals?page=<?php echo $total_pages; ?>">Last</a></li>
                                                <li class="page-item <?php if($page >= $total_pages){ echo 'disabled'; } ?>"><a class="page-link" href="<?php if($page >= $total_pages){ echo '#'; } else { echo "./dashboard/my-referrals?page=".($page + 1); } ?>">Next</a></li>
                                            </ul>
                                        </div>

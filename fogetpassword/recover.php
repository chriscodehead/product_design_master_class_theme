...
<?php 
$msg = '';
if(isset($_GET['id'])){$get_email = $_GET['id'];}else{header("location:../login");
													 }
if(isset($_GET['ip'])){$get_password = $_GET['ip'];}else{header("location:../login");
														}
if(isset($_GET['it'])){$get_code = $_GET['it'];}else{header("location:../login");
													}
if(isset($_POST['sub'])){

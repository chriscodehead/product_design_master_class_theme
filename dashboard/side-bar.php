            ...
            <div class="nk-sidebar-content">
                <div class="nk-sidebar-widget d-none d-xl-block">
                    ...
                    <ul class="user-account-data gy-1">
                        ...
                        <li>
                            <div class="user-account-label">
                                <span class="sub-text">Sponsor: </span>
                            </div>
                            <div class="user-account-value">
                                <span class="sub-text"> <?php print @$sqli->GetReferral($sqli->getRow($sqli->getEmail($_SESSION['user_code']),'referral_username'),'first_name');?> <span class="currency currency-btc"></span></span>
                            </div>
                        </li>
                    </ul>
                    <div class="user-account-actions">
                        <ul class="g-3">
                            ...
                            <li><a href="./dashboard/deposit" class="btn btn-lg btn-primary"><span>Activate</span></a></li>
                            <?php }else{?>
                                <li><a href="./dashboard/wallets" class="btn btn-lg btn-primary"><span>Wallets</span></a></li>
                            <?php }?>
                            <li><a href="./dashboard/withdraw" class="btn btn-lg btn-warning"><span>Withdraw</span></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="nk-sidebar-widget nk-sidebar-widget-full d-xl-none pt-0">
                    ...
                    <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                        ...
                        <ul class="user-account-links">
                            <li><a href="./dashboard/withdraw" class="link"><span>Withdraw Funds</span> <em class="icon ni ni-wallet-out"></em></a></li>
                            <?php if($sqli->getRow($sqli->getEmail($_SESSION['user_code']),'payment_activation_status')=='no' || $sqli->getRow($sqli->getEmail($_SESSION['user_code']),'usdt')=="" || $sqli->getRow($sqli->getEmail($_SESSION['user_code']),'email_activation')=="no"){?>
                            <li><a href="./dashboard/deposit" class="link"><span>Activate Account</span> <em class="icon ni ni-wallet-in"></em></a></li>
                            <?php }else{?>
                                <li><a href="./dashboard/wallets" class="link"><span>Wallets</span> <em class="icon ni ni-wallet-in"></em></a></li>
                            <?php }?>

                        </ul>
                        <ul class="link-list">
                            <li><a href="./dashboard/profile"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                            <li><a href="./dashboard/profile-security"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
                        </ul>
                        <ul class="link-list">
                ...
                <div class="nk-sidebar-menu">
                    <ul class="nk-menu">
                        ...
                        <li class="nk-menu-item">
                            <a href="./dashboard/notification" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-bell-fill"></em></span>
                                <span class="nk-menu-text">Signals/Notification</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/free-materials" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-folder"></em></span>
                                <span class="nk-menu-text">Free Course materials</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/wallets" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span>
                                <span class="nk-menu-text">Wallets</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/my-referrals" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-user-c"></em></span>
                                <span class="nk-menu-text">Referrals</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/commission" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span>
                                <span class="nk-menu-text">Commission</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/all-transaction" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span>
                                <span class="nk-menu-text">All Transaction</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/withdrawal-history" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span>
                        ...
                        <li class="nk-menu-item has-sub">
                            ...
                            <ul class="nk-menu-sub">
                                <li class="nk-menu-item">
                                    <a href="./dashboard/profile" class="nk-menu-link">
                                        <span class="nk-menu-text">My Profile</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="./dashboard/update-password" class="nk-menu-link"><span class="nk-menu-text">Update Password</span></a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="./dashboard/profile-security" class="nk-menu-link"><span class="nk-menu-text">Update Security PIN</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="nk-menu-item">
                            <a href="./dashboard/add-wallet" class="nk-menu-link">

    ...
    <div class="container-fluid">
        <div class="nk-footer-wrap">
            ...
            <div class="nk-footer-links">
                <ul class="nav nav-sm">
                    <li class="nav-item"><a target="_blank" class="nav-link" href="#">Terms</a></li>
                    <li class="nav-item"><a target="_blank" class="nav-link" href="#">Disclaimer</a></li>
                    <li class="nav-item"><a target="_blank" class="nav-link" href="#">Help</a></li>
                </ul>
            </div>
        </div>
    </div>

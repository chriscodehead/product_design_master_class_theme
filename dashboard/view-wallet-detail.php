                                        ...
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    <li><a href="./dashboard/withdraw" class="btn btn-white btn-dim btn-outline-light"><em class="icon ni ni-send"></em><span>Withdraw</span></a></li>
    ...
    <div class="card-inner-group">
                    ...
                    <div class="nk-tb-col">
                        <div class="nk-tnx-type">
                            ...
                            <div class="nk-tnx-type-text">
                                <span class="tb-lead"><?php print $sqli->getRow($row['referred_email'],'first_name');?> <?php print $sqli->getRow($row['referred_email'],'last_name');?></span>
        ...
        <div class="card-inner">
            <ul class="pagination justify-content-center justify-content-md-start">
                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>"><a class="page-link" href="<?php if($page <= 1){ echo '#'; } else { echo "./dashboard/view-wallet-detail?page=".($page - 1); } ?>&id=<?php print $level;?>">Prev</a></li>
                <li class="page-item"><a class="page-link" href="./dashboard/view-wallet-detail?page=1&id=<?php print $level;?>">1</a></li>
                <li class="page-item"><span class="page-link"><em class="icon ni ni-more-h"></em></span></li>
                <li class="page-item"><a class="page-link" href="./dashboard/view-wallet-detail?page=<?php echo $total_pages; ?>&id=<?php print $level;?>">Last</a></li>
                <li class="page-item <?php if($page >= $total_pages){ echo 'disabled'; } ?>"><a class="page-link" href="<?php if($page >= $total_pages){ echo '#'; } else { echo "./dashboard/view-wallet-detail?page=".($page + 1); } ?>&id=<?php print $level;?>">Next</a></li>
            </ul>
        </div>
